...
<head>
  ...
  <title>Freelancer - Commentaire</title>
...
<body id="page-top">
  ...
  <section class="page-section" id="contact">
    <div class="container">
      ...
      <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Commentraire</h2>
          ...
          <form name="sentMessage" id="contactForm" novalidate="novalidate">
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-0 pb-2">
                ...
                <input class="form-control" id="phone" type="tel" placeholder="Numéro" required="required" data-validation-required-message="Please enter your phone number.">
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <div class="control-group">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4 mb-5 mb-lg-0">
          ...
          <a class="btn btn-outline-light btn-social mx-1" href="#">
            <i class="fab fa-fw fa-dribbble"></i>zz
          </a>
        </div>
